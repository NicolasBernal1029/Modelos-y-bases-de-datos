...
INSERT INTO OFERTA VALUES (1001, TO_DATE('2023-10-01', 'YYYY-MM-DD'), 'Calle 1 #23-45', 'A', 500000, 1, 'D', 'UB001', 'U001');
INSERT INTO OFERTA VALUES (1002, TO_DATE('2023-09-20', 'YYYY-MM-DD'), 'Carrera 10 #45-67', 'C', 700000, 0, 'N', 'UB002', 'U002');
INSERT INTO OFERTA VALUES (1003, TO_DATE('2023-08-15', 'YYYY-MM-DD'), 'Avenida 5 #12-34', 'B', 600000, 1, 'V', 'UB003', 'U003');
...
INSERT INTO INTERES_EN VALUES ('M', 2003, 'UB003');
...
INSERT INTO ORIGEN_FONDOS VALUES (400000, 400000, 'Y', 2001);
INSERT INTO ORIGEN_FONDOS VALUES (450000, 450000, 'N', 2002);
INSERT INTO ORIGEN_FONDOS VALUES (500000, 500000, 'Y', 2003);
...
/*CREATE view max_oferta AS
SELECT *
FROM OFERTA
WHERE numero = (SELECT MAX(numero) FROM OFERTA);
...
BEGIN
    ...
    SELECT MAX(NUMERO) INTO max_num FROM max_oferta;
...
/*CREATE view max_Demanda AS
SELECT *
FROM DEMANDA
WHERE numero = (SELECT MAX(numero) FROM DEMANDA);

select * from max_DEMANDA;

CREATE TRIGGER TR_DEMANDA_BD
...
BEGIN
    -- Obtener el número máximo antes de la eliminación
    SELECT MAX(NUMERO) INTO max_num FROM max_demanda;
    -- Permitir la eliminación solo si es la última oferta
    IF :OLD.NUMERO != max_num THEN
        RAISE_APPLICATION_ERROR(-20002, 'No se puede eliminar la demanda porque no es la última registrada.');
    END IF;
END; 
*/
